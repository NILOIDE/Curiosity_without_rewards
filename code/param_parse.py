...
def parse_args():
    ...
    parser.add_argument('--env_name', type=str, default='GridWorldContinuousAction42x42-v0')
    # parser.add_argument('--env_name', type=str, default='MountainCarContinuous-v0')
    parser.add_argument('--save_dir', type=str, default='results/')
    parser.add_argument('--name', type=str, default='')
    parser.add_argument('--seed', help='RNG seed', type=int, default=1)
    parser.add_argument('--export_interval', type=int, default=10)
    parser.add_argument('--eval_interval', type=int, default=int(100))
    parser.add_argument('--buffer_size', type=int, default=int(2e2))
    parser.add_argument('--train_steps', type=int, default=int(10e4))
    ...
    parser.add_argument('--policy_h_dim', type=str, default='(64,)')
    ...
    parser.add_argument('--policy_tau', type=float, default=0.001)
    ...
    parser.add_argument('--wm_soft_target', type=bool, default=True)
    parser.add_argument('--wm_tau', type=float, default=0.001)
    ...
    args['policy_h_dim'] = make_tuple(args['policy_h_dim'])
